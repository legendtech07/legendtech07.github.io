...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Escape any value before it is placed into innerHTML.
    ...
    // isAdmin: true — enforce this with Firestore Security Rules too, so a
    // normal user can never set isAdmin on their own document. There is
    // intentionally no client-side password list: anything in this file is
            ...
            notificationsSnapshot.forEach(doc => {
                ...
                notificationElement.innerHTML = `
                    <div class="item-header">
                        <div>
                            <div class="item-title">${escapeHtml(notification.icon)} ${escapeHtml(notification.title)}</div>
                            <div class="item-meta">
                                <span class="badge ${typeBadges[notification.type] || 'badge-info'}">${escapeHtml(notification.type)}</span>
                    ...
                    <div class="item-content">${escapeHtml(notification.message)}</div>
                `;
        ...
        try {
            ...
            announcementsSnapshot.forEach(doc => {
                ...
                announcementElement.innerHTML = `
                    <div class="item-header">
                        <div>
                            <div class="item-title">${escapeHtml(announcement.title)}</div>
                            <div class="item-meta">
                                <span class="badge ${priorityBadges[announcement.priority] || 'badge-info'}">${escapeHtml(announcement.priority)}</span>
                    ...
                    <div class="item-content">${escapeHtml(announcement.message)}</div>
                `;
        ...
        try {
            ...
            broadcastsSnapshot.forEach(doc => {
                ...
                broadcastElement.innerHTML = `
                    <div class="item-header">
                        <div>
                            <div class="item-title">${escapeHtml(broadcast.title)}</div>
                            <div class="item-meta">
                                <span class="badge badge-info">${escapeHtml(broadcast.broadcastType)}</span>
                                <span class="badge badge-warning">${escapeHtml(broadcast.method)}</span>
                    ...
                    <div class="item-content">${escapeHtml(broadcast.message)}</div>
                    <div class="item-meta">
                        <small>Sent by: ${escapeHtml(broadcast.sentBy) || 'Admin'}</small>
                    </div>
                `;
