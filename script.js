...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Courses data - will be combined with Firestore courses
    let courses = [
        // ... (your existing courses array remains the same)
         { 
            id: 1, 
    ...
    const promoCodes = {
        'UPDATE': 500, // Example promo code that can only be used once
        'WELCOME100': 100,
        'LEGEND500': 500
    };
