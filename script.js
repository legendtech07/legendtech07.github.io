...
document.addEventListener('DOMContentLoaded', function() {
    ...
    class ChatNotificationManager {
        ...
        handleNewMessage(message) {
            ...
            if (messageTime > lastReadTime) {
                ...
                if (username && message.message && message.message.toLowerCase().includes(`@${username.toLowerCase()}`)) {
        ...
        showMentionNotification(message) {
            ...
            popup.innerHTML = `
                <div style="display: flex; align-items: flex-start; gap: 10px;">
                    <div style="font-size: 20px; color: #ff4444;">@</div>
                    <div style="flex: 1;">
                        <div style="font-weight: bold; margin-bottom: 5px; font-size: 14px; color: #ff4444;">
                            You were mentioned!
                        </div>
    ...
    // Confirm purchase handler - FIXED VERSION
    if (confirmPurchase) {
    ...
    async function updateCourseUnlocks(courseId) {
        try {
            ...
            const hardcodedCourse = courses.find(c => c.id === courseId);
            if (hardcodedCourse) {
    ...
    // Handle course interactions (likes/dislikes) - FIXED VERSION
